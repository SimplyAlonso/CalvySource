...
echo $fdsgdfgfd[$rand_keys[0]] . "\n";
    ...
    function undermaintenance($reason)
    {
		...
		<center><h4>Maintenance reason: <?php echo($reason); ?></h4></center>
        <?php
    }
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    if ($user->loggedin() && $renderall) {
                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/home/games">Games</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/home/catalog">Catalog</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/home/avatar">Avatar</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/home/download">Download</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="/home/events">Events</a>
                            </li>
                        </ul>

                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item">
                                <span class="nav-link active">$<?php echo $user->user()['namebux']; ?></span>
                            </li>
                        </ul>
                        <ul class="navbar-nav mr-auto">
                            <li class="nav-item dropstart nav-link">
                                <a role="button" id="imgav" data-bs-toggle="dropdown" class="dropstart"><img
                                            src="/images/default.png"
                                            style="width:30px;height:30px; border: 1px solid grey; border-radius: 50%;"></a>
                                <ul class="dropdown-menu dropdown-menu-left"
                                    aria-labelledby="imgav">
                                    <?php
                                    if ($user->admin()) {
                                        ?>
                                        <li><a class="dropdown-item" href="/home/admin">Admin</a></li>
                                        <?php
                                    }
                                    ?>
                                    <li><a class="dropdown-item" href="/home/settings">Settings</a></li>
                                    <li><a class="dropdown-item" href="/home/invites">Invites</a></li>
